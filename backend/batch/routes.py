...
def batch_grade():
    ...
    from backend.auth.session import current_user_id, plan_required
    from backend.batch.pipeline import run_batch_job
    from backend.batch.task_store import create_task
...
def batch_task(task_id: str):
    ...
    from backend.batch.task_store import get_task
